...
privileged aspect OwnerRepositoryImpl_Roo_Jpa_Repository_Impl {
    ...
    public Page<OwnerInfo> OwnerRepositoryImpl.findByCityLike(OwnerCityFormBean formBean, GlobalSearch globalSearch, Pageable pageable) {
        ...
        Path<?>[] paths = new Path<?>[] {getEntityId(),owner.firstName,owner.lastName,owner.city};        
        applyGlobalSearch(globalSearch, query, paths);
        ...
        return loadPage(query, pageable, Projections.constructor(OwnerInfo.class, getEntityId(), owner.firstName, owner.lastName, owner.city ));
    }
